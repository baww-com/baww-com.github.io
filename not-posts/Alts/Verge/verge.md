---
layout: page
title: How to Buy Verge Cryptocurrency
seo_title: "2 Ways to Buy Verge Cryptocurrency - Credit Card and Bank"
permalink: /verge/
---

## Verge ![VergeIcon](/img/verge.png){: .cryptoicons }


## How to Buy Verge with Credit Card and Debit Card

There is currently only one method of buying Verge with a credit or debit card. This is to convert currency into Bitcoin, then converting Bitcoin into Verge such as [Binance](https://www.binance.com/?ref=18991911){:target="_blank"}

## How to Buy Verge with Bank Transfer

There is one method of buying Verge with a bank wire or transfer. Please see below for a detailed explanation.

## Method 1 - USD/EUR -> BTC -> Verge
...
Once your Bitcoin arrives, you will have a balance with which to purchase Verge. Go to the [XVG/BTC page](https://www.binance.com/trade.html?symbol=XVG_BTC) and you will see a box that says Buy Verge. In the box, enter a price  with which you are comfortable. You can look at the order book to get a sense of the current rates. After your order is processed, you will see it in your Verge wallet balance in Binance!


![BuyVerge](/img/buyxvg.png){: .medium-pic}

## How to Buy Verge with PayPal

Due to Paypal's chargeback feature, buying Verge with Paypal requires one extra step. The exchange [VirWoX](https://www.virwox.com?r=22aa25){:target="_blank"} allows you to convert paypal balance into Bitcoin. [Read our tutorial on this conversion](/buy-bitcoin/paypal/). Once you have Bitcoin, you can send it to [Binance](https://www.binance.com/?ref=18991911) as seen in the example above.


## Can I Buy Verge on Coinbase?

Currently, Coinbase does not sell Verge. If you want to buy Verge, please follow the above steps. You can easily trade Bitcoin for Verge on [Binance](https://www.binance.com/?ref=18991911){:target="_blank"}. If you don't own any Bitcoin, use [Coinbase](https://www.coinbase.com/join/53bc38a3b11f6623df000004){:target="_blank"} to get started!

## Step 4: How to securely store Verge

Currently, Verge can be stored using a desktop wallet: [offical Verge Wallet](https://vergecurrency.com/#wallets).
