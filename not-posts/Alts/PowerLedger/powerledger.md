...
seo_title: "2 Ways to Buy PowerLedger Cryptocurrency - Credit Card and Bank"
...
There is currently only one way to buy PowerLedger with credit or debit card. This is to convert currency into Bitcoin, then converting Bitcoin into PowerLedger.

## How to Buy PowerLedger with Bank Transfer

There is one method of buying PowerLedger with a bank transfer or wire. Please see below for a detailed explanation.
...
![Coinbasehome](/img/Coinbase2.png){: .medium-pic}
 ...
 After hitting Confirm Buy, you are finished with this step! Next will be transferring the Bitcoin to a PowerLedger exchange. Also, at this point, we strongly suggest setting up two-factor authentication (2FA) on all exchanges. Two factor authentication combines two different verification methods to ensure the real user is trying to access the account.
...
## Step 3: Buy PowerLedger

Once your Bitcoin arrives, you will have a balance with which to purchase PowerLedger. Go to the [POWR/BTC page](https://www.binance.com/trade.html?symbol=POWR_BTC) and you will see a box that says Buy PowerLedger. In the box, enter a price with which you are comfortable. You can look at the order book to get a sense of the current rates. After your order is processed, you will see it in your PowerLedger wallet balance in Binance!

![PowerLedger](/img/plex.png){: .medium-pic}

## How to Buy PowerLedger with PayPal

Due to Paypal's chargeback feature, buying PowerLedger with Paypal requires one extra step. The exchange [VirWoX](https://www.virwox.com?r=22aa25){:target="_blank"} allows you to convert paypal balance into Bitcoin. [Read our tutorial on this conversion](/buy-bitcoin/paypal/). Once you have Bitcoin, you can send it to [Binance](https://www.binance.com/?ref=18991911) as seen in the example above.


## Step 4: How to securely store Power Ledger

PowerLedger is an ERC20 coin that runs on the Ethereum Blockchain, which means that it can be stored on [myEtherWallet](https://www.myetherwallet.com/).
PowerLedger is also easily and securely stored on the highly popular hardware wallet [Ledger Nano S!](https://www.ledgerwallet.com/r/607d)
...
Currently, there is a circulating supply approximately 356,220,000 POWR. This will eventually reach a cap of 1,000,000,000 POWR.
