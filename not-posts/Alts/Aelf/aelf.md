...
seo_title: "2 Ways to Buy Aelf Cryptocurrency - Credit Card and Bank Transfer"
permalink: /aelf/
---

## How to Buy Aelf with Credit Card and Debit Card

There is currently only one method of buying Aelf with a credit or debit card: convert your currency into Bitcoin, and then convert Bitcoin into Aelf using a cryptocurrency exchange.

## How to Buy Aelf with Bank Transfer

there is one method of buying Aelf with a bank transfer or wire. Please see below for a detailed explanation.
...
## Step 3: Buy Aelf with bitcoin on Binance

After your Bitcoin arrives, you will have a BTC balance with which to purchase Aelf. Go to the [ELF/BTC page](https://www.binance.com/trade.html?symbol=ELF_BTC) and you will see a box that says Buy Aelf. In the box, enter the price with which you are comfortable buying Aelf. To get a good idea, you can check the order book on either side of the console.

![buyaelf](/img/buyaelf.png){: .medium-pic}

## How to Buy Aelf with PayPal

Due to Paypal's chargeback feature, buying Aelf with Paypal requires one extra step. The exchange [VirWoX](https://www.virwox.com?r=22aa25){:target="_blank"} allows you to convert your Paypal balance into Bitcoin. [Check out this tutorial on this conversion](/buy-bitcoin/paypal/). Once you have Bitcoin, you can send it to [Binance](https://www.binance.com/?ref=18991911) just like the above example.


## Can I Buy Aelf on Coinbase?

Currently, Coinbase does not sell Aelf. Rumors suggest that in early 2018 several new coins, including Aelf, may be added to Coinbase. If you want to buy Aelf, please follow the steps above. You can trade Bitcoin for Aelf on [Binance](https://www.binance.com/?ref=18991911){:target="_blank"}. If you don't own any Bitcoin, use [Coinbase](https://www.coinbase.com/join/53bc38a3b11f6623df000004){:target="_blank"} to get started!


## Step 4: How to securely store Aelf

Aelf is an ERC20 coin that runs on the Ethereum Blockchain, which means that it can be stored on [myEtherWallet](https://www.myetherwallet.com/).
...
At the time of this writing, there is a circulating supply of approximately 250 million Aelf. This will eventually reach a cap of 260,000,000 Aelf.	
