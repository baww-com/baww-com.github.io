...
seo_title: "2 Ways to Buy Neo Cryptocurrency - Credit or Debit Card and Bank Account"
permalink: /neo/
---

## Neo ![neoIcon](/img/Neo.jpg){: .cryptoicons}

## How to Buy Neo with Credit Card or Debit Card
...
The best way to obtain Neo with a bank transfer is to buy Bitcoin on [Coinbase](https://www.coinbase.com/join/53bc38a3b11f6623df000004){:target="_blank"}, then send that Bitcoin to an exchange that trades Neo such as [Binance](https://www.binance.com/?ref=18991911){:target="_blank"}. Please see tutorial below.
...
[Coinmama](https://www.coinmama.com/?ref=buyaltcoinsworldwide){:target="_blank"}, or [BitPanda](https://www.bitpanda.com/?ref=7989064235904733469){:target="_blank"} are the easiest to use.
...
After hitting Confirm Buy, you are finished with this step! Next will be transferring the Bitcoin to a NEO exchange. Also, at this point, we strongly suggest setting up two-factor authentication (2FA) on all exchanges. Two factor authentication combines two different verification methods to ensure the real user is trying to access the account.
...
After you send bitcoin to Binance, go to the [BTC/NEO trading page](https://www.binance.com/trade.html?symbol=NEO_BTC){:target="_blank"} and enter a price  with which you are comfortable. You can look at the order book to get a sense of the current rates. After your order is processed, you will see it in your NEO wallet balance in Binance!

![Coinbasehome](/img/neoex.png){: #biggerpicture}

## How to Buy Neo on Changelly

Currently, Neo is not sold on Changelly. If you are interested in getting Neo, use [Binance](https://www.binance.com/?ref=18991911){:target="_blank"} and follow the instructions above.


## Can I Buy Neo on Coinbase?

Currently, Coinbase does not sell Neo. If you want to buy Neo, please follow the steps above. You can easily trade Bitcoin for Neo on [Binance](https://www.binance.com/?ref=18991911){:target="_blank"}. If you don't own any Bitcoin, use [Coinbase](https://www.coinbase.com/join/53bc38a3b11f6623df000004){:target="_blank"} to get started!

## How to Buy Neo with PayPal

Due to Paypal's chargeback feature, buying Neo with Paypal requires one extra step. The exchange [VirWoX](https://www.virwox.com?r=22aa25){:target="_blank"} allows you to convert paypal balance into Bitcoin. [Read our tutorial on this conversion](/buy-bitcoin/paypal/). Once you have Bitcoin, you can send it to Binance as seen in the example above.

## How to securely store Neo 
