...
seo_title: "2 Ways to Buy NXT Cryptocurrency - Credit Card and Bank"
permalink: /nxt/
---
...
There are two ways to buy NXT with a credit or debit card. The first is to convert currency into Bitcoin, then convert Bitcoin into NXT. The second way is to use [Changelly](https://changelly.com/?ref_id=4af50f9c87f2){:target="_blank"} which is faster but has higher fees to purchase.

## How to Buy NXT with Bank Transfer

There are two ways to buy NXT with a bank transfer or wire. See our tutorial below for instructions on each method.
...
![Coinbasehome](/img/Coinbase2.png){: .medium-pic}
 ...
 After hitting Confirm Buy, you are finished with this step! Next will be transferring the Bitcoin to a NXT exchange. Also, at this point, we strongly suggest setting up two-factor authentication (2FA) on all exchanges. Two factor authentication combines two different verification methods to ensure the real user is trying to access the account.
...
Once you have Bitcoin, you will need to move it to an exchange that has BTC/NXT pairs. [Bittrex](https://bittrex.com/Home/Markets){:target="_blank"} is a popular choice among crypto traders as it has an intuitive interface and responsive customer support. Click the send button on Coinbase as seen in the picture below (highlighted in red). Next, you will be asked to enter the recipient's wallet address. Enter your Bittrex Bitcoin address here, which you can find by going to the "Wallets" page on Bittrex and clicking the plus + sign next to "Bitcoin" as seen in the second picture below. Copy and paste the address into the recipient's box on Coinbase.
...
### Step 2: Upon creating an account, go to the main page as seen here, and use the conversion box to initiate an exchange. In this example, we are going to buy NXT with USD.
...
Currently, Coinbase does not sell NXT. If you want to buy NXT, please follow the above steps by starting with Bitcoin. If you don't have any Bitcoin, use [Coinbase](https://www.coinbase.com/join/53bc38a3b11f6623df000004){:target="_blank"} to get started!


## How to Buy NXT with PayPal

Due to Paypal's chargeback feature, buying NXT with Paypal requires one extra step. The exchange [VirWoX](https://www.virwox.com?r=22aa25){:target="_blank"} allows you to convert paypal balance into Bitcoin. [Read our tutorial on this conversion](/buy-bitcoin/paypal/). Once you have Bitcoin, you can send it to Bittrex as seen in the example above.


## Step 4: How to securely store NXT

NXT is an ERC20 coin that runs on the Ethereum Blockchain, which means that it can be stored using [myEtherWallet](https://www.myetherwallet.com/) and is also easily and securely stored on the highly popular hardware wallet [Ledger Nano S!](https://www.ledgerwallet.com/r/607d) 
