---
layout: page
title: How to Buy Ethereum Classic ETC Cryptocurrency
seo_title: "2 Ways to Buy Ethereum Classic Cryptocurrency - Credit or Debit Card and Bank Transfer"
...
The easiest way to obtain Ethereum Classic with a credit or debit card is to buy Bitcoin, then trade BTC/ETC pairs on [Binance](https://www.binance.com/?ref=18991911){:target="_blank"}.  Another way to purchase ETC with a credit or debit card is to use [Changelly](https://changelly.com/?ref_id=4af50f9c87f2){:target="_blank"}.

[Changelly](https://changelly.com/?ref_id=4af50f9c87f2){:target="_blank"} is more instant and direct, but has slightly higher fees. Please see tutorial below.

## How to Buy Ethereum Classic with Bank Transfer

There are two ways to buy Ethereum Classic with a bank transfer or wire. See explanations below.
...
After hitting Confirm Buy, you are finished with this step! Next will be transferring the Bitcoin to a Ethereum Classic exchange. Also, at this point, we strongly suggest setting up two-factor authentication (2FA) on all exchanges. Two factor authentication  combines two different verification methods to ensure the real user is trying to access the account.
...
Once you have bitcoin, you will need to move it to an exchange that has BTC/ETC pairs.
...
After sending your Bitcoin to [Binance](https://www.binance.com/?ref=18991911){:target="_blank"}, you will want to go to the [BTC/ETC trading page](https://www.binance.com/trade.html?symbol=ETC_BTC){:target="_blank"} and enter a price  with which you are comfortable. You can look at the order book to get a sense of the current rates. After your order is processed, you will see it in your Ethereum Classic wallet balance in Binance!
...
### Step 2: Upon creating an account, go to the main page as seen here, and use the conversion box to initiate an exchange. In this example, we are going to buy Ethereum Classic with USD.
...
Due to Paypal's chargeback feature, buying Ethereum Classic with Paypal takes some extra work. The exchange [VirWoX](https://www.virwox.com?r=22aa25){:target="_blank"} allows you to convert paypal balance into Bitcoin. [Read our tutorial on this conversion](/buy-bitcoin/paypal/). Once you have Bitcoin, you can send it to Binance as seen in the example above.

## Can I Buy Ethereum Classic on Coinbase?

Coinbase does not currently sell Ethereum Classic. If you want to buy Ethereum Classic, please follow the steps above. You can easily trade Bitcoin for Ethereum Classic on [Binance](https://www.binance.com/?ref=18991911){:target="_blank"}. If you don't own any Bitcoin, use [Coinbase](https://www.coinbase.com/join/53bc38a3b11f6623df000004){:target="_blank"} to get started!

## How to mine Ethereum Classic?

In order to mine most cryptocurrencies, you will need at least one powerful graphics card and power supply to support it. Check out [Whattomine.com](https://whattomine.com){:target="_blank"} for more information on mining Ethereum Classic and other cryptocurrencies.

## How to securely store Ethereum Classic

If you are looking for a hardware wallet, Ethereum Classic is easily and securely stored on the highly popular hardware wallet [Ledger Nano S!](https://www.ledgerwallet.com/r/607d){:target="_blank"}.

Ethereum Classic is an ERC20 coin that runs on the Ethereum Blockchain, which means that it can be stored on [myEtherWallet](https://www.myetherwallet.com/).
