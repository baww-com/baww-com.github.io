---
layout: page
title: How to Buy Waves Cryptocurrency
seo_title: "2 Ways to Buy Waves Cryptocurrency - Credit Card and Bank"
permalink: /waves/
---


## Waves ![WavesIcon](/img/waves.png){: .cryptoicons }


## How to Buy Waves with Credit Card and Debit Card

The easiest and cheapest way to get Waves with a debit or credit card is to buy Bitcoin with your credit or debit card, send it to an exchange that sells Waves, such as [Binance](https://www.binance.com/?ref=18991911){:target="_blank"}.

## How to Buy Waves with Bank Transfer

The best way obtaining Waves with a Bank Transfer is to buy Bitcoin on [Coinbase](https://www.coinbase.com/join/53bc38a3b11f6623df000004){:target="_blank"}, then send it to an exchange that sells Waves like [Binance](https://www.binance.com/?ref=18991911){:target="_blank"}.


## Method 1 - USD/EUR -> BTC -> Waves
...
![Coinbasehome](/img/Coinbase2.png){: .medium-pic}
 ...
 After hitting Confirm Buy, you are finished with this step! Next will be transferring the Bitcoin to a Waves exchange. Also, at this point, we strongly suggest setting up two-factor authentication (2FA) on all exchanges. Two factor authentication  combines two different verification methods to ensure the real user is trying to access the account.


## Bitcoin to Waves Exchanges
...
Once you have Bitcoin, you will need to move it to an exchange that has BTC/WAVES pairs.
...
After sending your bitcoin to Binance, go to the [BTC/WAVES trading page](https://www.binance.com/trade.html?symbol=WAVES_BTC){:target="_blank"} and enter a price with which you are comfortable. You can look at the order book to get a sense of the current rates. After your order is processed, you will see it in your Waves wallet balance in Binance!

![Waves](/img/wavex.png){: #biggerpicture}


## How to Buy Waves with Changelly
...
### Step 2: Upon creating an account, go to the main page as seen here, and use the conversion box to initiate an exchange. In this example, we are going to buy Waves with USD.
...
Currently, Coinbase does not sell Waves. Follow the steps above to learn how to buy Waves. If you want to buy Waves, please follow the above steps. You can easily trade Bitcoin for Waves on [Binance](https://www.binance.com/?ref=18991911){:target="_blank"}. If you don't own any Bitcoin, use [Coinbase](https://www.coinbase.com/join/53bc38a3b11f6623df000004){:target="_blank"} to get started!



## How to Buy Waves with PayPal

Due to Paypal's chargeback feature, buying Waves with Paypal requires one extra step. The exchange [VirWoX](https://www.virwox.com?r=22aa25){:target="_blank"} allows you to convert paypal balance into Bitcoin. [Read our tutorial on this conversion](/buy-bitcoin/paypal/). Once you have Bitcoin, you can send it to Bittrex as seen in the example above.


## Step 4: How to securely store Waves

Waves is an ERC20 coin that runs on the Ethereum Blockchain, which means that it can be stored on [myEtherWallet](https://www.myetherwallet.com/).
Waves is also easily and securely stored on the highly popular hardware wallet [Ledger Nano S!](https://www.ledgerwallet.com/r/607d)
