---
layout: page
title: How to Buy Stratis Cryptocurrency
seo_title: "2 Ways to Buy Stratis Cryptocurrency - Credit Card and Bank"
permalink: /stratis/
---

## Stratis ![StratisICON](/img/stratis.png){: .cryptoicons }


## How to Buy Stratis with Credit Card and Debit Card

The easiest and cheapest way to get Stratis with a debit or credit card, is to buy Bitcoin with your credit or debit card, hen send it to an exchange that sells Stratis such as Binance [Binance](https://www.binance.com/?ref=18991911){:target="_blank"}.


## How to Buy Stratis with Bank Transfer

The best method of buying Stratis with a bank account is to convert currency into Bitcoin using Coinbase, then convert Bitcoin into Stratis on [Binance](https://www.binance.com/?ref=18991911){:target="_blank"}. Please see below for a detailed explanation.

## Method 1 - USD/EUR -> BTC -> Stratis
...
![Coinbasehome](/img/Coinbase2.png){: .medium-pic}
 ...
 After hitting Confirm Buy, you are finished with this step! Next will be transferring the Bitcoin to a Stratis exchange. Also, at this point, we strongly suggest setting up two-factor authentication (2FA) on all exchanges. Two factor authentication  combines two different verification methods to ensure the real user is trying to access the account.


## Bitcoin to Stratis Exchanges
<table class="basic-table" align="center">
 <tr>
  <th>Exchange</th>
  <th>Countries</th>
...
Once your Bitcoin arrives, you will have a balance with which to purchase Stratis. Go to the [STRAT/BTC page](https://www.binance.com/trade.html?symbol=STRAT_BTC) and you will see a box that says Buy Stratis. In the box, enter a price with which you are comfortable. You can look at the order book to get a sense of the current rates. After your order is processed, you will see it in your Stratis wallet balance in Binance!

![BuyEOS](/img/buystrat.png){: .medium-pic}

## Can I Buy Stratis on Coinbase?

Currently, Coinbase does not sell Stratis. If you want to buy Stratis, please follow the above steps. You can easily trade Bitcoin for Stratis on [Binance](https://www.binance.com/?ref=18991911){:target="_blank"}. If you don't own any Bitcoin, use [Coinbase](https://www.coinbase.com/join/53bc38a3b11f6623df000004){:target="_blank"} to get started!

## How to Buy Stratis with PayPal

Due to Paypal's chargeback feature, buying Stratis with Paypal requires one extra step. The exchange [VirWoX](https://www.virwox.com?r=22aa25){:target="_blank"} allows you to convert paypal balance into Bitcoin. [Read our tutorial on this conversion](/buy-bitcoin/paypal/). Once you have Bitcoin, you can send it to [Binance](https://www.binance.com/?ref=18991911) as seen in the example above.


## Step 4: How to securely store Stratis

Read our guide on [Stratis wallets!](/wallets/stratis/)
