...
seo_title: "2 Ways to Buy EOS Cryptocurrency - Credit or Debit Card and Bank Transfer"
permalink: /eos/
---
...
There is currently only one method of buying EOS with a credit or debit card. This is to convert currency into Bitcoin, then convert Bitcoin into EOS.

## How to Buy EOS with Bank Transfer

There is one method of buying EOS with a bank transfer or wire. Please see tutorial below.
...
After hitting Confirm Buy, you are finished with this step! Next will be transferring the Bitcoin to a EOS exchange. Also, at this point, we strongly suggest setting up two-factor authentication (2FA) on all exchanges. Two factor authentication  combines two different verification methods to ensure the real user is trying to access the account.
...
Once you have Bitcoin, you will need to move it to an exchange that has BTC/EOS pairs.
...
After your Bitcoin arrives, you will have a balance with which to purchase EOS. Go to the [EOS/BTC page](https://www.binance.com/trade.html?symbol=EOS_BTC) and you will see a box that says Buy EOS. In the box, enter a price with which you are comfortable. You can look at the order book to get a sense of the current rates. After your order is processed, you will see it in your EOS wallet balance in Binance!

![BuyEOS](/img/buyeos.png){: .medium-pic}

## How to Buy EOS with PayPal

Due to Paypal's chargeback feature, buying EOS with Paypal takes extra work. The exchange [VirWoX](https://www.virwox.com?r=22aa25){:target="_blank"} allows you to convert paypal balance into Bitcoin. [Read our tutorial on this conversion](/buy-bitcoin/paypal/). Once you have Bitcoin, you can send it to [Binance](https://www.binance.com/?ref=18991911) just like the example above.


## Can I Buy EOS on Coinbase?

Coinbase does not currently sell EOS. If you want to buy EOS, please follow the steps above. You can trade Bitcoin for EOS on [Binance](https://www.binance.com/?ref=18991911){:target="_blank"}. If you don't own any Bitcoin, please use [Coinbase](https://www.coinbase.com/join/53bc38a3b11f6623df000004){:target="_blank"} to get started!

## Step 4: How to securely store EOS

EOS is an ERC20 coin that runs on the Ethereum Blockchain, which means that it can be stored on [myEtherWallet](https://www.myetherwallet.com/). EOS is also easily and securely stored on the highly popular hardware wallet [Ledger Nano S!](https://www.ledgerwallet.com/r/607d)
...
At the time of this writing, there is a circulating supply of approximately 557,000,000 EOS. This will eventually reach a cap of 1,000,000,000 EOS.
