...
seo_title: "2 Ways to Buy Decentraland Cryptocurrency - Credit Card and Bank Transfer"
permalink: /decentraland/
---


## How to Buy Decentraland with Credit or Debit Card

There is currently only one method of buying Decentraland with a credit or debit card. This is to convert your currency into Bitcoin, and then convert Bitcoin into Decentraland.

## How to Buy Decentraland with Bank Transfer

There is one method of buying Decentraland with a bank transfer or wire. Please see the tutorial below.
...
After hitting Confirm Buy, you are finished with this step! Next will be transferring the Bitcoin to a Decentraland exchange. Also, at this point, we strongly suggest setting up two-factor authentication (2FA) on all exchanges. Two factor authentication combines two different verification components to ensure the real user is trying to access the account.
...
After securing Bitcoin, you will need to move it to an exchange that has BTC/MANA pairs.
...
## Step 3: Buy Decentraland

Once your Bitcoin arrives, you will have a balance with which to purchase Decentraland. Go to the [MANA/BTC page](https://www.binance.com/trade.html?symbol=MANA_BTC) and you will see a box that says Buy Decentraland. In the box, enter a price with which you are comfortable. You can look at the order book to get a sense of the current rates. After your order is processed, you will see it in your Decentraland wallet balance in Binance!

![Decentraland](/img/buymana.png){: .medium-pic}

## How to Buy Decentraland with PayPal

Due to Paypal's chargeback feature, buying Decentraland with Paypal requires one extra step. The exchange [VirWoX](https://www.virwox.com?r=22aa25){:target="_blank"} allows you to convert paypal balance into Bitcoin. [Read our tutorial on this conversion](/buy-bitcoin/paypal/). Once you have Bitcoin, you can send it to [Binance](https://www.binance.com/?ref=18991911) just like the example above.


## Step 4: How to securely store Decentraland

Decentraland is a coin that runs on the Ethereum Blockchain, which means that it can be stored on [myEtherWallet](https://www.myetherwallet.com/). Decentraland is also easily and securely stored on the highly popular hardware wallet [Ledger Nano S!](https://www.ledgerwallet.com/r/607d)
