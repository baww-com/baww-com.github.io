...
seo_title: "2 Ways to Buy Qtum Cryptocurrency - Credit Card and Bank"
permalink: /qtum/
---
...
The best method of buying Qtum with credit or debit card is to convert currency into Bitcoin using [Coinbase](https://www.coinbase.com/join/53bc38a3b11f6623df000004){:target="_blank"}, then converting Bitcoin into Qtum on an exchange that sells Qtum such as [Binance](https://www.binance.com/?ref=18991911){:target="_blank"}.

## How to Buy Qtum with Bank Transfer

The best method of buying Qtum with a bank account is to convert currency into Bitcoin using Coinbase, then convert Bitcoin into Qtum on [Binance](https://www.binance.com/?ref=18991911){:target="_blank"}. Please see below for a detailed explanation.
...
![Coinbasehome](/img/Coinbase2.png){: .medium-pic}
 ...
 After hitting Confirm Buy, you are finished with this step! Next will be transferring the Bitcoin to a Qtum exchange. Also, at this point, we strongly suggest setting up two-factor authentication (2FA) on all exchanges. Two factor authentication  combines two different verification methods to ensure the real user is trying to access the account.
...
After you send bitcoin to Binance, go to the [BTC/QTUM trading page](https://www.binance.com/trade.html?symbol=QTUM_BTC){:target="_blank"} and enter a price with which you are comfortable. You can look at the order book to get a sense of the current rates. After your order is processed, you will see it in your Qtum wallet balance in Binance!

![Qtum](/img/qtumex.png){: #biggerpicture}

## Can I Buy Qtum on Coinbase?

Currently, Coinbase does not sell Qtum. If you want to buy Qtum, please follow the above steps. You can easily trade Bitcoin for Qtum on [Binance](https://www.binance.com/?ref=18991911){:target="_blank"}. If you don't have any Bitcoin, use [Coinbase](https://www.coinbase.com/join/53bc38a3b11f6623df000004){:target="_blank"} to get started!

## How to Buy Qtum with PayPal

Due to Paypal's chargeback feature, buying Qtum with Paypal requires one extra step. The exchange [VirWoX](https://www.virwox.com?r=22aa25){:target="_blank"} allows you to convert paypal balance into Bitcoin. [Read our tutorial on this conversion](/buy-bitcoin/paypal/). Once you have Bitcoin, you can send it to Bittrex as seen in the example above.


## Step 4: How to securely store Qtum

Qtum is an ERC20 coin that runs on the Ethereum Blockchain, which means that it can be stored using [myEtherWallet](https://www.myetherwallet.com/).
Qtum is also easily and securely stored on the highly popular hardware wallet [Ledger Nano S!](https://www.ledgerwallet.com/r/607d)
